...
(1,'Arailym','arailym@mail.com','+7701','2025-01-10'),
(2,'Amina','amina@mail.com','+7702','2025-02-14');
...
CREATE TABLE instructor (
 ...
 salary NUMERIC CHECK( salary BETWEEN 30000 and 200000)
 office_number TEXT UNIQUE
)

INSERT INTO instructor VALUES ( first_name 'Arailym', last_name 'Oralova', instructor_id 833, email 'oralova@mail.ru', hire_date '23.10', salary 35000, office_number '77')
INSERT INTO instructor VALUES ( first_name 'Saltanat', last_name 'Kanaeva', instructor_id 555, email 'kss00@mail.ru', hire_date '12.10', salary 40000, office_number '23')

-- TASK 2
CREATE TABLE university_courses(
    course_id INT PRIMARY KEY
    course_code TEXT NOT NULL and UNIQUE
    course_name TEXT NOT NULL
    instuctor_id INT REFERENCES instructors(instuctor_id)
    credits NOT NULL INT CHECK (credits BETWEEN 1 and 5)
    max_students NOT NULL INT CHECK (max_students BETWEEN 5 and 100)
    semester NOT NULL TEXT CHECK(semester in ('Fall', 'Spring', 'Summer'))
)

INSERT INTO university_courses VALUES (course_id 'CS101', course_code '101', course_name 'PP1', instructor_id '24B031077', credits 4, max_students '50', semester 'Fall' )
INSERT INTO university_courses VALUES (course_id 'MATH2201', course_code '202', course_name 'Discreate Math', instructor_id '24B107703', credits 5, max_students '70', semester 'Summer' )
